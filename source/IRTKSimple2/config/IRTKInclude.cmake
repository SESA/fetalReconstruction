...
IF (ZLIB_FOUND)
  #ADD_DEFINITIONS(-DHAS_ZLIB -DHAVE_ZLIB) #MAFJAS
...
#ADD_DEFINITIONS(-DIMPERIAL -DANSI -DHAS_CONTRIB -DNO_BOUNDS -DENABLE_UNIX_COMPRESS) # SMAFJAS
...
IF (BUILD_WITH_NIFTI)
   ...
   #ADD_DEFINITIONS(-DHAS_ZLIB) #SMAFJAS
